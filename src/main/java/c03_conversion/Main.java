...
public class Main {
    public static void main(String[] args) {
        ...
        //upcasting(더 큰 용량의 자료형으로 변환시키는 것)
        //1) upcasting의 첫 번째 방법
        char cast1 = 'A';
        System.out.println("원형 : "+cast1);
        // 형변환을 하기 위해서는 '(바꿀데이터타입)' 변수명을 작성한다.
        ...
        //2) upcasting의 두번째방법
        char cast3 = 'b';
        // upcasting을 진행 할 변수를 새로운 '자료형 변수형 = 기존 변수;'형태로 작성
        int cast4 = cast3 ;
        System.out.println(cast3);
        System.out.println(cast4);

        //downcasting(더 작은 용량의 자료형으로 변환시키는 것)
        int cast5 = 99;
