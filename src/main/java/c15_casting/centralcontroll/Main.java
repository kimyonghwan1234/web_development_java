...
public class Main {
    public static void main(String[] args) {
        ...
        //led1은 1번지
        // speaker1은 2번지
        //tv1은 3번지에 각각 centralControl의 객체 내의 배열에 집어넣어 보세요
...
//        centralControl.displayInfo3();
        ...
        //String으로 바뀌어서 콘솔에 출력되게 된다.

        //배열의 각 요소들을 on시키려면 어떻게 작성해야 할까요? ->그래서 메서드들을 확인해서 그 구조가 어떻게 되는지
        //확인 할 필요가 있다. 해당 경우 powerOn() 메서드 내에 이미 반복문이 위치해있기 때문에
        centralControl.powerOn();
        centralControl.powerOff();
//        centralControl.displayInfo();
        //Mouse클래스를 정의하고, main에서 객체 mouse1을 생성
        //배열에 집어넣고
