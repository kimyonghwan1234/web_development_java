...
//
//        System.out.println("첫 번째 과목의 점수를 입력하세요>>>");
//        score1= scanner.nextDouble();
//        System.out.println("두 번쨰 과목의 점수를 입력하세요>>>");
...
//            endOfCalc=true; //endOfCalc라는 변수를 true로 바꿔줌으로써 반복문 종료 ->
                //다음 반복문이 실행될 때 boolean 연산자의 t/f를 검증하기 때문에 그 전까지는 그대로 실행됨
            }
...
//                    "평균 점수는 "+totalScore/totalSubjects+"점 입니다.");
