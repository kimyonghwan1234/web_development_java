...
/*
    ...
    2. return 값이 없다. ->마치 call1(). call2() 유형같은 식으로 받아들일 수 있다.
...
public class Constructor {
    ...
    //매개 변수 생성자 -> 기본적으로 만들어지지 않습니다. 개발자가 정의해야 함. call2()형태가 됨.
    Constructor(int number) {
        ...
        Constructor(int num, String name){
            System.out.println("ALLArgsConstructor(int 매개변수를 필수로 요구하는 생성자)");
            this.num=num;
            this.name=name;
        }
    ...
    //생성자가 호출될 때 RequiredArgsConstructor(int 매개변수를 필수로 요구하는 생성자)가 콘솔창에 찍히도록 작성하세요

    //이후 ConstructorMain.java에서 Constructor  Constructor4 = new Constructor("김일");을 통해 객체를 생성하세요
    //김일 이름을 가진 객체의 num필드에 20을 입력하소
