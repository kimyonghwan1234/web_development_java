...
/*
    1. Setter / Getter의 필요성
        문제상황
        클래스를 만든다고 가정해보겠습니다. 예를 들어, 사람(person)클래스를 만들면서 이름(name), 나이(age) 등의
        정보를 저장하기 위해 필드를 선언했습니다.
        ...
        그리고 PersonMain에서 객체를 생성했다고 가정하겠습니다.
        class PersonMain {
        ...
        방법이 없는 문제가 있습니다. -> 이를 해결하기 위한 방법 : Setter/ Getter개념
        ...
        2. Setter / Getter란?
            ...
            Getter
              ...
              수업 내용 확인을 위해 파일 내부를 겁색하려면 ctr + f
              여태까지 수업한 전체 패카지 및 파일 확인에서 내용 확인하려면
              ctr + shift + f
              ...
              3) 캡슐화 유지
                    ...
                    외부에 노출하지 않음
              4) 유연성 증가
                    나중에 요구사항이 바뀌어 데이터를 설정하거나 조회하는 방법이 변경되더라고
              ...
              4. 그래서 Setter/ Getter는 언제나 필수적인가?
                    ...
                    Setter/ Getter를 이용하는 것이 '효과적'이다.

                    거의 대부분 사용하기 때문에 alt +ins등을 지원하고
                    추후 수업할 lombok 애너테이션을 사용하는 편이다.
