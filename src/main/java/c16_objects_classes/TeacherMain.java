...
public class TeacherMain {
    public static void main(String[] args) {
        ...
        //teacher1객체의 클래스 정보 얻기
        Class tClass = teacher1.getClass();
//
//        System.out.println(tClass);
//        //class c16_objects_classes.Teacher ->결과값
...
//            System.out.println(fields[i].getType().getSimpleName());    //필드의 타빙(자료형) 출력
//            System.out.println();
//        }
...
//            System.out.println();
//        }
        //이하의 코드의 경우 배열 전체를 출력할 경우 사람이 보기에 가독성이 떨어지기 떄문에
...
//        System.out.println(Arrays.toString(methods));
        ...
        c16_objects_classes.equals_test.Teacher teacher3 = new c16_objects_classes.equals_test.Teacher("안근수", "코리아아이티");
        // teacher3의 경우 다른 경로에 있는 Teacher 클래스의 인스턴스
//        System.out.println(teacher3 instanceof Teacher);
        //이상의 코드의 경우 Teacher가 .equals_test 패키지에 있는 클래스가 아니라 c16_object_classes에 있기 때문에
        //오류 발생
...
//        System.out.println(teacher3.getClass()==Teacher.class);   위와 같은 이유로 오류발생
