...
/*
    싱글톤 패턴(Singletone Pattern)
     ...
     2. 전역 접근법: 싱글톤 인스턴스는 '정적 메서드'를 통하여 어디서든 접근할 수 있음.
     ...
     싱글톤 패턴의 장점:
        ...
        2. 글로벌접근: 전역적으로 접근할 수 있어 관리가 용이 ->하지만 잦은 접근 자체는 단점
        3. 일관성 유지 : 애플리케이션 전반에서 하나의 인스턴스만 사용하기 때문에 상태 일관성을 유지

      싱글톤 패턴의 단점:
        1. 테스트 어려움: 싱글톤 패턴은 전역적으로 사용되므로 단위 테스트가 어려움
        2. 의존성 숨심: 싱글톤을 남용하면 클래스간의 의존성을 추적하기 어려울 수 있음 ->신중히 사용해야 함.
...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        SmartPhone smartPhone1 = factory1.produceSmartPhone();  //또 새로운 방식으로 객체 생성
